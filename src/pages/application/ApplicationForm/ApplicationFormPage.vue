          ...
          <v-tabs>
            ...
            <v-tab title="Merchant Information">
              <div class="application-form-row">
                <template
                  v-for="field of columns['Merchant Information']"
                  :key="field.label"
                >
                  <form-field
                    size="md"
            ...
            <v-tab title="Ownership Information">
              <div class="application-form-row">
                <template
                  v-for="field of columns['Ownership Information']"
                  :key="field.label"
                >
                  <form-field
                    size="md"
            ...
            <v-tab title="Activity Range">
              <div class="application-form-row">
                <template
                  v-for="field of columns['Activity Range']"
                  :key="field.label"
                >
                  <form-field
                    size="md"
            ...
            <v-tab title="Type of Integration">
              <div class="application-form-column">
                <template
                  v-for="field of columns['Type of Integration']"
                  :key="field.label"
                >
                  <form-field
                    v-if="field.type === 'checkbox'"
            ...
            <v-tab title="Additional features">
              <div class="application-form-column">
                <template
                  v-for="field of columns['Additional features']"
                  :key="field.label"
                >
                  <form-field
                    v-if="field.type === 'checkbox'"
            ...
            <v-tab title="Merchant Portal">
              <div class="application-form-column">
                <template
                  v-for="field of columns['Merchant Portal']"
                  :key="field.label"
                >
                  <form-field
                    size="md"
    ...
    const columns = {
      ...
      "Merchant Information": [
        { type: "text", label: "Registered Name", model: "merchant.name" },
        {
          type: "text",
          label: "Trading Name",
          model: "merchant.tranding_name",
        },
        {
          type: "text",
          label: "Business Registration Number",
          model: "merchant.number",
        },
        {
          type: "text",
          label: "Registration Date",
          model: "merchant.registration_date",
        }, // datepicker
        {
          type: "text",
          label: "Website / Live URL",
          model: "merchant.website",
        },
        {
          type: "text",
          label:
        ...
        {
          type: "text",
          label: "License and related documetnation",
          model: "merchant.documents",
        },
        {
          type: "text",
          label: "Contact Person’s Name",
          model: "merchant.contact_person_name",
        },
        {
          type: "text",
        ...
        {
          type: "text",
          label: "IT Manager’s Mobile Number",
          model: "merchant.it_person_phone",
        },
        {
          type: "text",
          label: "IT Manager’s Email Address",
          model: "merchant.it_person_email",
        },
        {
          type: "text",
      ...
      "Ownership Information": [
        ...
        {
          type: "text",
          label: "Registration No. / ID Card No.",
          model: "owneship.id_card",
        },
        {
          type: "text",
          label: "Ownership Structure",
          model: "owneship.structure",
        },
        {
          type: "text",
          label: "Registered Address",
          model: "owneship.address",
        },
      ...
      Limits: [
        {
          ...
          model: "limits.terminal_currency",
        },
        {
          type: "text",
          label: "Terminal Time Zone",
          model: "limits.terminal_timezone",
        },
        {
          type: "text",
          label: "Average Transaction Daily Amount",
          model: "limits.trans_avg",
        },
        {
          type: "text",
          label: "Estimated Monthly Volume",
          model: "limits.estimated_month_value",
        },
        {
          type: "text",
          label: "Average Ticket Size",
          model: "limits.avg_ticket_size",
        },
        {
          type: "text",
          label: "Maximum Ticket Size",
          model: "limits.max_ticket_size",
        },
        { type: "text", label: "Maximum TPS", model: "limits.max_tps" },
        { type: "text", label: "Average TPS", model: "limits.avg_tps" },
        {
          type: "text",
          label: "Refund daily avarage Amount",
          model: "limits.refund_amount",
        },
      ],
      "Activity Range": [
        {
          type: "text",
          label: "Expected transaction peak time slot/s",
          model: "activity_range",
        },
      ],
      "Type of Integration": [
        {
        ...
        },
        {
          ...
          children: [
            { label: "Bank Payment Page" },
            { label: "Via API (PSI DSS Mandatory)" },
          ],
        },
      ],
      "Additional features": [
        {
          ...
          children: [
            ...
            { label: "dual message (Pre-auth; capture)" },
          ],
        },
        {
          type: "checkbox",
      ...
      "Merchant Portal": [
        ...
        {
          type: "text",
          label: "Merchant Portal Admin user Information, Name, surname, Email",
        },
      ],
