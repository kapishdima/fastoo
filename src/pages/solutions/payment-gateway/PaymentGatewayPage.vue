    ...
    <section class="section-row">
      <div class="section-content">
        <p class="paragraph--md">
          ...
          up-to-date product corresponding to the latest requirements and standards.
        </p>
        <br />
        <p class="paragraph--md">
        ...
        <ul class="paragraph--md">
          <li>
            <b>Fraud monitoring system</b>. The mission of any fraud monitoring system is to prevent
            fraudulent activity before it happens. This system monitors merchant accounts for
            unusual or suspicious spending actions, and in case there is something irregular, the
            customer receives a phone call from one of our operator to be sure that transaction is
            veritable.
          </li>
          <li>
            <b>3D secure</b>. As soon as customer credit card passes 3-D secure verification, the
            merchant’s business becomes totally protected from any unapproved transactions or claims
            about unauthorized access.
          </li>
          <li>
            <b>2 step authentication</b>. The feature is additional step which has to be passed on
            the way of making a purchase. Usually a special code is sent via SMS on cardholder’s
            mobile phone which virtually reduces possibilities of fraud actions.
          </li>
          <li>
            <b>Address Verification System (AVS)</b>. AVS compares the billing address provided by
            the cardholder with the address on file at the credit card company. Nowadays AVS is
            widely used in United States and Canada.
          </li>
          <li>
            <b>IP geolocation</b>. The system is able to compare location of cardholder with
            physical location of credit card. In case something is suspicious the owner receives a
            phone call for proving.
          </li>
          <li>
            <b>Velocity monitoring</b>. Velocity monitoring is a technique used in the banking
            industry to detect potential fraudulent use of a debit card by analyzing sudden and
            dramatic changes in debit card usage.
          </li>
        </ul>
