<template>
  <v-page classes="payments-page">
    <section-banner :bg="require('@/assets/section-bg.png')" title="Recurring Billing service" />
    <section class="section-row">
      <div class="section-content">
        ...
        <br />
        <p class="paragraph--md">
          In case you sell products and services on a recurring payments basis you can seriously
          ease and protect your business. RegularPay automatic recurring billing service drastically
          decreases your efforts spent on processing of customers’ payments allowing your clients to
          simply type their card details once, thereby agree that all following payments will be
          took out from their accounts at a certain time.
        </p>
        <br />
        <p class="paragraph--md">
          Moreover, using this recurring billing service you can be sure that all due payments will
          be passed on time, hence there is no need to remind your clients about terms of payments.
        ...
        <p class="paragraph--md">
          ...
          have already been monitored by our anti-fraud system.
        </p>
        <br />
        <p class="paragraph--md">
      ...
      <div class="section-sidebar">
        <navigation-card :list="navigationList" :active-index="4" />
      </div>
    </section>
  </v-page>
</template>
