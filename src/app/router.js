...
const routes = [
  ...
  {
    path: pathes.SOLUTION_MULTICURRENCY_PROCESSING,
    component: MulticurrencyProcessing,
  },
...
export const menu = [
  { path: pathes.INDEX, title: "Home" },
  {
    ...
    children: [
      ...
      {
        path: pathes.SOLUTION_RECURRING_BILLING,
        title: "Recurring Billing service",
      },
      {
        path: pathes.SOLUTION_MULTICURRENCY_PROCESSING,
        title: "Multicurrency Processing",
      },
